...
if (isset($updateUser)) {
 ...
 <div class="card ">
   <div class="card-header">
          <h3>User Profile <span class="float-end"> <a href="index.php" class="btn btn-primary">Back</a> </h3>
        </div>
        <div class="card-body">
          ...
          <div style="width:600px; margin:0px auto">
              ...
              <?php if (Session::get("id") == $getUinfo->id) {?>
                  <div class="form-group py-2">
                    ...
                    <a class="btn btn-primary" href="changepass.php?id=<?php echo $getUinfo->id;?>">Change Password</a>
                  </div>
